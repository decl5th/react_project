...
const JoinForm = ({form, onSubmit, onChange, onToggle, onReset, errors }) => {
    ...
    <FormBox autoComplete="off" onSubmit={onSubmit}>
        ...
        <dl>
            <dt>{t('이메일')}</dt>
            <dd>
                <InputBox type="text" name="email" value={form.email ?? ''} onChange={onChange} />
        ...
        <dl>
            <dt>{t('비밀번호')}</dt>
            <dd>
                <InputBox type="password" name="password" value={form.password ?? ''} onChange={onChange} />
        ...
        <dl>
            <dt>{t('비밀번호_확인')}</dt>
            <dd>
                <InputBox type="password" name="confirmPassword" value={form.confirmPassword ?? ''} onChange={onChange}
                />
        ...
        <dl>
            <dt>{t('회원명')}</dt>
            <dd>
                <InputBox type="text" name="name" value={form.name ?? ''} onChange={onChange}/>
        ...
        <BigButton type="button" color="light" onClick={onReset} >{t('다시입력')}</BigButton>
